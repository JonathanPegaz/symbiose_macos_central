...
class BoltToy: SpheroV2Toy {
    ...
    func drawMatrix(fillFrom startPixel: Pixel, to endPixel: Pixel, color: NSColor) {
        let clampedStart = clampPixel(startPixel)
        let clampedEnd = clampPixel(endPixel)
    ...
    func scrollMatrix(text: String, color: NSColor, speed: Int, loop: ScrollingTextLoopMode) {
