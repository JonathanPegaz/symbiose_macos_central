...
public struct SetBoltLEDCommand: UserIOCommand {
    ...
    public init(ledMask mask: LEDMask, color: NSColor) {
        self.ledMask = mask
        self.color = color
    }
...
public struct DrawMatrixPixel: UserIOCommand {
    ...
    public init(x: UInt8, y: UInt8, color: NSColor) {
        self.x = x
        self.y = y
        self.color = color
    }
...
public struct DrawMatrixLine: UserIOCommand {
    ...
    public init(startX: UInt8, startY: UInt8, endX: UInt8, endY: UInt8, color: NSColor) {
        self.startX = startX
        self.startY = startY
        self.endX = endX
        self.endY = endY
...
public struct SetMatrixScrollingText: UserIOCommand {
    ...
    public init(text: String, color: NSColor, speed: UInt8, loop: UInt8) {
        self.text = text
        self.color = color
        self.speed = speed
        self.loop = loop
